import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, watchEffect, createBlock, createCommentVNode, unref, openBlock, withCtx, resolveDynamicComponent, normalizeProps, guardReactiveProps, renderSlot, createTextVNode, toDisplayString, createElementBlock, toRef, inject, hasInjectionContext, toValue, getCurrentInstance, onServerPrefetch, Fragment, renderList, mergeProps, provide, createVNode, ref, watch, useSlots, resolveComponent, nextTick, isRef, shallowRef, h, mergeModels, useModel, normalizeClass, defineAsyncComponent, cloneVNode, useSSRContext, Suspense, createApp, useId, shallowReactive, withAsyncContext, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, e as createError$1, l as klona, m as defuFn, n as defu, o as parseQuery, q as isEqual, t as getContext, i as hasProtocol, j as joinURL, w as withQuery, v as withTrailingSlash, x as withoutTrailingSlash, y as isScriptProtocol, z as sanitizeStatusCode, $ as $fetch$1, A as baseURL, B as createHooks, C as executeAsync, D as toRouteMatcher, E as createRouter$1, f as destr, F as getRequestHeader, G as setCookie, H as getCookie, I as deleteCookie } from '../nitro/nitro.mjs';
import { routerKey, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { isFilled, asLinkAttrs, asImageWidthSrcSet, asImagePixelDensitySrcSet, asText, asHTML, createClient, documentToLinkField, asImageSrc, asDate, cookie, filter, asLink } from '@prismicio/client';
import { asTree } from '@prismicio/client/richtext';
import { DEV } from 'esm-env';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttrs, ssrRenderStyle, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    path: "/api/preview",
    component: () => import('./PrismicPreview-C0zATyFP.mjs')
  },
  {
    name: "uid",
    path: "/:uid()",
    component: () => import('./_uid_-BIU376cn.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BUsNGVqU.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DFImaW21.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-z1uMhbV3.mjs')
  },
  {
    name: "slice-simulator",
    path: "/slice-simulator",
    component: () => import('./slice-simulator-C9BheRko.mjs')
  },
  {
    name: "terms-and-conditions",
    path: "/terms-and-conditions",
    component: () => import('./terms-and-conditions-uJ6onhzs.mjs')
  }
];
...
const _hoisted_1$1 = ["src", "srcset", "alt"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _ctx.node.type === "heading1" ? (openBlock(), createElementBlock("h1", {
        ...
        _ctx.node.linkTo ? (openBlock(), createBlock(_sfc_main$p, {
          key: 0,
          field: _ctx.node.linkTo
        }, {
          default: withCtx(() => [
            createVNode(_sfc_main$q, { field: _ctx.node }, null, 8, ["field"])
          ]),
          _: 1
        }, 8, ["field"])) : (openBlock(), createBlock(_sfc_main$q, {
          key: 1,
          field: _ctx.node
        }, null, 8, ["field"]))
      ])) : _ctx.node.type === "embed" ? (openBlock(), createBlock(_sfc_main$r, {
        key: 15,
        field: _ctx.node.oembed
      }, null, 8, ["field"])) : _ctx.node.type === "hyperlink" ? (openBlock(), createBlock(_sfc_main$p, {
        key: 16,
        ...
        return openBlock(), createElementBlock(Fragment, { key: line }, [
          index2 > 0 ? (openBlock(), createElementBlock("br", _hoisted_16)) : createCommentVNode("", true),
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function getComponent(child) {
      var _a;
      return ((_a = props.components) == null ? void 0 : _a[CHILD_TYPE_RENAMES[child.type] || child.type]) || _sfc_main$o;
    }
    return (_ctx, _cache) => {
      ...
      return openBlock(true), createElementBlock(Fragment, null, renderList(props.children, (child) => {
        return openBlock(), createBlock(resolveDynamicComponent(getComponent(child)), {
          ...
          node: child.node,
          "link-resolver": getComponent(child) === _sfc_main$o ? props.linkResolver : void 0
        }, {
          default: withCtx(() => [
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return isModern.value && (unref(isFilled).richText(__props.field) || __props.fallback) ? (openBlock(), createBlock(_sfc_main$t, {
        key: 0,
        wrapper: __props.wrapper
      }, {
        default: withCtx(() => [
          children.value.length ? (openBlock(), createBlock(_sfc_main$n, {
            key: 0,
        ...
        _: 1
      }, 8, ["wrapper"])) : !isModern.value ? (openBlock(), createBlock(_sfc_main$s, {
        key: 1,
        field: __props.field,
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const renderedSlices = computed(() => {
      return props.slices.map((slice, index2) => {
        var _a, _b;
        const type = "slice_type" in slice ? slice.slice_type : slice.type;
        const key = "id" in slice && typeof slice.id === "string" ? slice.id : `${index2}-${JSON.stringify(slice)}`;
    ...
    return (_ctx, _cache) => {
      return _ctx.slices ? (openBlock(), createBlock(_sfc_main$t, {
        key: 0,
...
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(isFilled).richText(_ctx.field) || _ctx.fallback ? (openBlock(), createBlock(_sfc_main$t, {
        key: 0,
        wrapper: _ctx.wrapper
      }, {
        default: withCtx(() => [
...
const plugin_dZwLP3pabhznAX15ySw1eaAQmwVOMPFRcNoLlER2dWI = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const prismicPlugin = createPrismic({
      ...
      components: {
        linkInternalComponent: __nuxt_component_2$1,
        linkExternalComponent: __nuxt_component_2$1,
        ...options.components,
        linkRel,
        richTextComponents,
...
const _sfc_main$f = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$g : unref(Primitive)), mergeProps({ as: __props.as }, props.chip ? typeof props.chip === "object" ? { inset: true, ...props.chip } : { inset: true } : {}, {
        class: ui.value.root({ class: [props.ui?.root, props.class] }),
        style: props.style
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        __props.icon ? (openBlock(), createBlock(_sfc_main$h, {
                          key: 0,
                          name: __props.icon,
                          class: ui.value.icon({ class: props.ui?.icon })
          ...
          if (_push2) {
            ...
            return [
              __props.custom ? renderSlot(_ctx.$slots, "default", mergeProps({ key: 0 }, {
                ...
                isExternal,
                active: isLinkActive({ route: linkRoute, isActive, isExactActive })
              })) : (openBlock(), createBlock(_sfc_main$e, mergeProps({ key: 1 }, {
                ..._ctx.$attrs,
                ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                as: __props.as,
                type: __props.type,
      ...
      _push(ssrRenderComponent(unref(ToastRoot), mergeProps({
        ...
        default: withCtx(({ remaining, duration, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "leading", {}, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$f, mergeProps({
                  key: 0,
                  size: props.ui?.avatarSize || ui.value.avatarSize()
                }, __props.avatar, {
                  class: ui.value.avatar({ class: props.ui?.avatar })
...
const __nuxt_component_0 = Object.assign(_sfc_main$7, { __name: "UApp" });
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))}><defs><linearGradient id="strategrowGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="${ssrRenderStyle({ "stop-color": "#F68E15", "stop-opacity": "1" })}"></stop><stop offset="100%" style="${ssrRenderStyle({ "stop-color": "#CB5588", "stop-opacity": "1" })}"></stop></linearGradient></defs><path d="M0 0 C3.7325737 2.9970912 5.70894304 6.65235129 6.5859375 11.2734375 C6.65218257 13.02230731 6.67146345 14.77346498 6.6484375 16.5234375 C6.63941406 17.41546875 6.63039062 18.3075 6.62109375 19.2265625 C6.60369141 20.23976563 6.60369141 20.23976563 6
-17 21.34 -17 4 C-5.96296296 -0.73015873 -5.96296296 -0.73015873 0 0 Z " fill="url(#strategrowGradient)" transform="translate(251,173)"></path><path d="M0 0 C3.53018625 4.61805997 3.45821659 9.36661145 3.375 14.9375 C3.38660156 15.71029297 3.39820313 16.48308594 3.41015625 17.27929688 C3.37627383 23.95978046 2.11274651 28.84767754 -2.7109375 33.76171875 C-6.29673998 36.20193825 -9.51173479 37.5629523 -13.625 38.8125 C-14.60726562 39.13637695 -14.60726562 39.13637695 -15.609375 39.46679688 C-18.9365489 40.52758612 -21.46865558 41 -25 41 C-25 29.12 -25 17.24 -25 5 C-22.174375 3.989375 -19.34875 2.97875 -16.4375 1.9375 C-15.56150146 1.61515381 -14.68550293 1.29280762 -13.78295898 0.96069336 C-8.90508446 -0.72218712 -5.06886375 -1.73223465 0 0 Z " fill="url(#strategrowGradient)" transform="translate(138,266)"></path><path d="M0 0 C2.56616092 1.61014019 2.95166227 2.83400118 3.80078125 5.75 C5.21012332 14.70093589 5.42915483 22.30921827 1.1875 30.5 C-2.68882489 34.93008559 -7.12835644 36.53306845 -12.6875 38.1875 C-13.82574219 38.53167969 -14.96398437 38.87585938 -16.13671875 39.23046875 C-19 40 -19 40 -21 40 C-21 28.45 -21 16.9 -21 5 C-6 0 -6 0 0 0 Z " fill="url(#strategrowGradient)" transform="translate(134,207)"></path><path d="" fill="url(#strategrowGradient)" transform="translate(0,0)"></path><path d="" fill="url(#strategrowGradient)" transform="translate(0,0)"></path></svg>`);
}
...
const __nuxt_component_1$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$1]]), { __name: "Logo" });
const useColorMode = () => {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UColorModeButton = _sfc_main$5;
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "p-4 md:px-6 md:pb-2 md:pt-4 border-b border-[#DFE4FE] dark:border-[#FFFFFF1C]" }, _attrs))}><nav class="mx-auto flex max-w-7xl justify-between py-2 md:items-center font-medium text-white" aria-label="Main"><div class="flex items-center justify-between">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h1 class="opacity-0 hidden"${_scopeId}>Brand Strategy Playbook</h1><span class="sr-only"${_scopeId}>${ssrInterpolate(_ctx.settings?.data.site_title)} BSP </span>`);
          } else {
            return [
              createVNode(_component_Logo),
              createVNode("h1", { class: "opacity-0 hidden" }, "Brand Strategy Playbook"),
              createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.settings?.data.site_title) + " BSP ", 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><ul class="gap-4 flex items-center"><!--[-->`);
      ssrRenderList(_ctx.settings?.data.navigation, (link) => {
        _push(`<li>`);
        _push(ssrRenderComponent(_component_PrismicLink, {
          field: link,
          class: ["inline-flex min-h-11 scroll-smooth items-center font-poppins 3 text-primary dark:text-white font-medium transition duration-300 hover:scale-110", {
...
const __nuxt_component_1 = Object.assign(_sfc_main$4, { __name: "AppHeader" });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_2$1;
  const _component_Logo = __nuxt_component_1$1;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "rounded-2xl mt-20 mb-10 p-4 md:py-6 md:px-12 bg-figma-soft dark:bg-[#1828591f] dark:footer-flow ring-1 ring-white/15" }, _attrs))}><div class="max-w-7xl mx-auto py-10"><div class="flex flex-col md:flex-row gap-5 justify-between"><div class="space-y-2 w-full md:w-1/2">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "z-50"
  }, {
  ...
  _push(`<p class="text-base text-[#2E3754] dark:text-white/70 mt-5 font-inter"> Turn scattered brand ideas into a crisp, investor-ready playbook in under an hour. </p></div><nav class="space-y-2"><h3 class="text-lg font-poppins font-semibold text-custom-black dark:text-white">Legal</h3><ul class="space-y-1"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/privacy-policy",
    class: "text-base text-[#2E3754] dark:text-white/70 mt-5 font-inter transition-colors duration-300 hover:text-primary"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
  ...
  _push(`</li></ul></nav><nav class="space-y-2"><h3 class="text-lg font-poppins font-semibold text-custom-black dark:text-white">Support</h3><ul class="space-y-1"><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/contact",
    class: "text-base text-[#2E3754] dark:text-white/70 mt-5 font-inter transition-colors duration-300 hover:text-primary"
  }, {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Agency Partners`);
      } else {
        return [
          createTextVNode("Agency Partners")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</li></ul></nav></div><div class="mt-10 pt-6 border-t border-[#0B0515] dark:border-[#FFFFFF1C]"><p class="text-xs text-[#070A17] dark:text-white/70 text-[15px] font-inter"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Stralegrow LLC. All Rights Reserved </p></div></div></footer>`);
}
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender]]), { __name: "AppFooter" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: settings } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "settings",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dark:glow"${_scopeId}><div class="max-w-7xl mx-auto px-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppHeader, { settings: unref(settings) }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_AppFooter, null, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            return [
              createVNode("div", { class: "dark:glow" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4" }, [
                  createVNode(_component_AppHeader, { settings: unref(settings) }, null, 8, ["settings"]),
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dark:glow"${_scopeId}><div class="max-w-7xl mx-auto px-4"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppHeader, { settings: unref(settings) }, null, _parent2, _scopeId));
            _push2(`<div class="text-center my-30"${_scopeId}><h1 class="font-poppins text-brand-blue dark:text-white text-5xl font-bold"${_scopeId}>${ssrInterpolate(__props.error?.statusCode)}</h1>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              to: "/",
              class: "text-custom-black font-medium hover:text-brand-blue hover:underline transition dark:text-primary"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Go back home`);
            ...
            return [
              createVNode("div", { class: "dark:glow" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4" }, [
                  createVNode(_component_AppHeader, { settings: unref(settings) }, null, 8, ["settings"]),
                  createVNode("div", { class: "text-center my-30" }, [
                    createVNode("h1", { class: "font-poppins text-brand-blue dark:text-white text-5xl font-bold" }, toDisplayString(__props.error?.statusCode), 1),
...
export { get as A, _sfc_main$m as B, _sfc_main$p as C, _sfc_main$r as D, _sfc_main$q as E, _sfc_main$i as F, useLocale as G, _export_sfc as _, useRouter as a, useHead as b, useRoute as c, useAsyncData as d, entry$1 as default, createError as e, _sfc_main$j as f, useAppConfig as g, formBusInjectionKey as h, formStateInjectionKey as i, formErrorsInjectionKey as j, formInputsInjectionKey as k, formLoadingInjectionKey as l, formOptionsInjectionKey as m, inputIdInjectionKey as n, formFieldInjectionKey as o, useFormField as p, useFieldGroup as q, useComponentIcons as r, _sfc_main$h as s, tv as t, usePrismic as u, _sfc_main$f as v, looseToNumber as w, useToast as x, _sfc_main$c as y, useSeoMeta as z };
