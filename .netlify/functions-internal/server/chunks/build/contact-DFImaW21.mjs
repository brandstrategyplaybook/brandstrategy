import { defineComponent, mergeProps, withCtx, createVNode, createTextVNode, resolveDynamicComponent, renderSlot, reactive, unref, computed, useId, inject, provide, ref, readonly, useSlots, toDisplayString, createBlock, createCommentVNode, openBlock, watch, nextTick, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderAttrs } from 'vue/server-renderer';
import { useEventBus, useVModel } from '@vueuse/core';
import { z as useSeoMeta, x as useToast, y as _sfc_main$c, g as useAppConfig, t as tv, h as formBusInjectionKey, i as formStateInjectionKey, j as formErrorsInjectionKey, k as formInputsInjectionKey, l as formLoadingInjectionKey, m as formOptionsInjectionKey, n as inputIdInjectionKey, o as formFieldInjectionKey, p as useFormField, q as useFieldGroup, r as useComponentIcons, s as _sfc_main$h, v as _sfc_main$f, w as looseToNumber } from './server.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(_ctx.as || "div"), _attrs, {
...
const __nuxt_component_0 = Object.assign(_sfc_main$6, { __name: "Wrapper" });
...
const _sfc_main$5 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isNested = ((_b = props.nested) == null ? void 0 : _b.toString()) === "" || props.nested === true;
    ...
    async function _validate(opts = { silent: false, nested: false, transform: false }) {
      ...
      if (names) {
        ...
        const patterns = names.map((name) => {
          var _a3, _b3;
          return (_b3 = (_a3 = inputs.value) == null ? void 0 : _a3[name]) == null ? void 0 : _b3.pattern;
        }).filter(Boolean);
      ...
      if (opts.transform) {
        ...
        return (_b2 = transformedState.value) != null ? _b2 : state.value;
      }
      return state.value;
    }
    ...
    const api = {
      ...
      setErrors(errs, name) {
        ...
        for (const form of nestedForms.value.values()) {
          const errors2 = errs.flatMap((e) => {
            ...
            if ((_a2 = e == null ? void 0 : e.name) == null ? void 0 : _a2.startsWith(form.name + `.`)) {
              return [{
                ...e,
                name: e == null ? void 0 : e.name.split(form.name + `.`)[1]
              }];
            }
            return [];
          });
      ...
      clear(name) {
        ...
        for (const form of nestedForms.value.values()) {
          ...
          else if (typeof name === "string" && (name == null ? void 0 : name.startsWith(form.name + `.`))) {
            const nestedName = name == null ? void 0 : name.split(`${form.name}.`)[1];
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme$2), ...((_a = appConfig.ui) == null ? void 0 : _a.formField) || {} })({
        size: props.size,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const schema = z.object({
      ...
      message: z.string("Invalid message").min(8, "Must be at least 8 characters").max(256, "Must be at most 256 characters")
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UForm, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex gap-6"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UFormField, {
              label: "Name",
              name: "name",
              class: "font-poppins text-base w-1/2"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_UFormField, {
              label: "Message",
              name: "message",
              class: "font-poppins text-base w-full"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_UButton, {
              type: "submit",
              class: "font-poppins cursor-pointer buttonLink bg-brand-gradient dark:hover:opacity-85 text-white"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Send Message `);
            ...
            _push2(`<p class="pl-2 text-sm font-poppins"${_scopeId}>Prefer email? Write us at <a href="mailto:support@brandplaybookapp.com" class="text-custom-gradient hover:opacity-90"${_scopeId}>support@brandplaybookapp.com.</a> We will respond within 24 hours.</p></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "flex items-center" }, [
                ...
                createVNode("p", { class: "pl-2 text-sm font-poppins" }, [
                  createTextVNode("Prefer email? Write us at "),
                  createVNode("a", {
                    href: "mailto:support@brandplaybookapp.com",
                    class: "text-custom-gradient hover:opacity-90"
                  }, "support@brandplaybookapp.com."),
                  createTextVNode(" We will respond within 24 hours.")
                ])
              ])
            ];
          }
...
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "ContactForm" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "contact",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "Contact Us - Brand Strategy PlayBook"
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Wrapper = __nuxt_component_0;
      const _component_ContactForm = __nuxt_component_1;
      _push(ssrRenderComponent(_component_Wrapper, mergeProps({
        as: "main",
        class: "max-w-5xl mx-auto my-10 md:my-20"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section class="flex flex-col gap-4"${_scopeId}><div class="w-full"${_scopeId}><h1 class="text-4xl font-poppins text-custom-black dark:text-white md:text-7xl font-bold"${_scopeId}> Talk to the <span class="text-custom-gradient"${_scopeId}>BSP Team</span></h1><p class="text-sm md:text-xl opacity-80 text-[#2E3754] dark:text-[#A1A4B5] fon-inter fullHeroParagraph leading-relaxed"${_scopeId}>Whether you\u2019re exploring BSP or already building your brand strategy, our team is here to help you get clarity, faster. Send us a note\u2014we\u2019ll respond within 1 business day.</p></div><div class="w-full md:flex-1 items-center md:justify-items-center mx-auto"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ContactForm, null, null, _parent2, _scopeId));
            _push2(`</div></section>`);
          } else {
            return [
              createVNode("section", { class: "flex flex-col gap-4" }, [
                createVNode("div", { class: "w-full" }, [
                  createVNode("h1", { class: "text-4xl font-poppins text-custom-black dark:text-white md:text-7xl font-bold" }, [
                    createTextVNode(" Talk to the "),
                    createVNode("span", { class: "text-custom-gradient" }, "BSP Team")
                  ]),
                  createVNode("p", { class: "text-sm md:text-xl opacity-80 text-[#2E3754] dark:text-[#A1A4B5] fon-inter fullHeroParagraph leading-relaxed" }, "Whether you\u2019re exploring BSP or already building your brand strategy, our team is here to help you get clarity, faster. Send us a note\u2014we\u2019ll respond within 1 business day.")
                ]),
                createVNode("div", { class: "w-full md:flex-1 items-center md:justify-items-center mx-auto" }, [
...
//# sourceMappingURL=contact-DFImaW21.mjs.map
