...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: policy, pending, error } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "privacy-policy",
      () => client.getSingle("privacy_policy")
      // <-- replace with your exact API ID if different
    )), __temp = await __temp, __restore(), __temp);
    const title = computed(() => {
      var _a, _b;
      return ((_b = (_a = policy.value) == null ? void 0 : _a.data) == null ? void 0 : _b.meta_title) || "Privacy Policy";
    });
    const description = computed(() => {
      var _a, _b;
      return ((_b = (_a = policy.value) == null ? void 0 : _a.data) == null ? void 0 : _b.meta_description) || "Privacy Policy";
    });
    useSeoMeta({ title, description });
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e, _f;
      const _component_SliceZone = _sfc_main$j;
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "policy-page max-w-6xl m-auto" }, _attrs))} data-v-0f34dc9c>`);
      if (unref(error)) {
        _push(`<pre data-v-0f34dc9c>${ssrInterpolate(unref(error).message)}</pre>`);
      } else if (unref(pending)) {
        _push(`<div data-v-0f34dc9c>Loading\u2026</div>`);
      } else {
...
const privacyPolicy = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0f34dc9c"]]);

export { privacyPolicy as default };
//# sourceMappingURL=privacy-policy-z1uMhbV3.mjs.map
